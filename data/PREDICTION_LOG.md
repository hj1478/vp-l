...
⚠️ **Label caveat:** **9 cycle(s)** have a firing time known (by extrapolation to target) to within 15 min. The **tight-label** row is the trustworthy one; looser cycles carry larger label error.

**Tight-label OOS MAE:** 54.8 min (n=656 predictions, 9 cycle(s))
**Tight-label MAE by stage:** 0-25%=93.0m  ·  25-50%=71.4m  ·  50-75%=48.2m  ·  75-90%=33.2m  ·  90-100%=14.7m

_All-cycle (contaminated) MAE: 59.7 min over 1154 predictions — do not trust._
